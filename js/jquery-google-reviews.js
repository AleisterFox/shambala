  ...
  $.fn.googlePlaces = function (options) {
    ...
    var renderReviews = function (reviews) {
      ...
      for (var i = rowCount; i >= 0; i--) {
        ...
        var name = settings.shortenNames
          ...
          : review.author_name;
        var style =
          review.text.length > parseInt(settings.textBreakLength)
            ? "review-item-long"
            : "review-item";
    ...
    var callback = function (place, status) {
      ...
      $.each(obj, function (i, elemento) {
        ...
        let profilePicture = elemento.profile_photo_url;
        ...
        cont +=
          ...
          "</div>" +
          "<h3>" +
          elemento.author_name +
          "</h3>" +
          // '<span class="fecha">' +
          // elemento.relative_time_description +
          // "</span>" +
          "<p>" +
          elemento.text +
          "</p>" +
